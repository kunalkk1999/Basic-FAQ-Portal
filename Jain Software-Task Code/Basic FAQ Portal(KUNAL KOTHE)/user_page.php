            ...
            <div class="mt-8 opacity-75">
               <svg class="w-1/2 max-w-screen-sm mx-auto" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <path
                     ...
                     transform="translate(-156.25 -227.99512)" fill="#2f2e41" />
                  <polygon points="366.909 125.259 320.608 126.409 314.376 71.2 366.909 71.2 366.909 125.259"
                     fill="#2f2e41" />
                  <path
                  ...
                  <polygon points="329.165 93.171 324.658 117.959 343.812 126.973 348.319 95.425 329.165 93.171"
                     fill="#ffb8b8" />
                  <path
                  ...
                  <path d="M1043.75,427.51514H646.71v-199.52h397.04Zm-395.04-2h393.04v-195.52H648.71Z"
                     transform="translate(-156.25 -227.99512)" fill="#3f3d56" />
                  <path
                     d="M844.08008,390.28522a16.13845,16.13845,0,1,1-16.15015-16.15A16.10482,16.10482,0,0,1,844.08008,390.28522Z"
                     transform="translate(-156.25 -227.99512)" fill="#667eea" />
                  <path
                     d="M844.08008,390.28522a16.13845,16.13845,0,1,1-16.15015-16.15A16.10482,16.10482,0,0,1,844.08008,390.28522Z"
                     transform="translate(-156.25 -227.99512)" opacity="0.3" />
                  <path
